 ...
 */
case class Scenic(id : Int,name:String,info:String,ticket:String,location:String,traffic:String,notice:String,cityId:Int,areaId:Int,url:String,urlLarge:String,enable:Int,stars:Int,culture:Int,heritage:Int,sight:Int,brief:String,yomi:String)

object Scenic {
  private val db = MyDatabase.database

  implicit val result = GetResult(r => Scenic(r.<<, r.<<, r.<<, r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<,r.<<))
